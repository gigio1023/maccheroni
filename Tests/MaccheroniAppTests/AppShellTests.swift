...
struct AppShellTests {
    ...
    func stringCatalogKeepsD16LocaleStateAndPlaceholderParity() throws {
        ...
        let requiredFinalKeys: Set<String> = [
            ...
            "The speaker separation model this profile needs is not installed on this Mac.",
            "The voice activity model this profile needs is not installed on this Mac.",
            "The local speech runtime this profile needs is missing or does not match its pinned version.",
            "The folder Maccheroni saves recordings and runs in cannot be reached.",
            "Another local component this profile needs is not ready.",
            "Maccheroni cannot use the microphone. Turn Maccheroni on in System Settings > Privacy & Security > Microphone.",
            "System audio is not recordable yet. Turn Maccheroni on in System Settings > Privacy & Security > Screen & System Audio Recording.",
            "Install the missing components by running this in Terminal from the Maccheroni repository, then check again:",
            "Maccheroni could not check whether this profile is ready: %@",
            "Maccheroni could not read the readiness report from its command-line engine.",
            "%@ of %@ (%@)",
            ...
            "This stage covered only part of the recording.",
            "This stage stopped the run.",
            "Transcribed",
        ]
