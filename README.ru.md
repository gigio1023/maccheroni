...
<picture>
  ...
  <img src="docs/assets/pipeline-light.drawio.svg" alt="Схема конвейера: на Mac запись питает диаризацию всего файла и 120-секундные листы ASR с внедрением глоссария в каждый лист; слияние по временным меткам, где таймлайн определяет говорящих, ведёт к необязательной постобработке на устройстве; Mac покидает только опциональная полоса Codex, и только с ограниченным текстом" width="100%">
</picture>
