...
Maccheroni — личный инструмент: настраиваемый рабочий стенд, который на одном
Mac превращает разговоры со смешением языков в записи с указанием говорящих.
Пользователь настраивает его под свои задачи, а не под требования рынка.

- **Профили составляют конфигурацию для каждого разговора.** Каждый профиль
  сочетает закреплённую локальную модель ASR, контекст глоссария и обработку
  говорящих по всему файлу в соответствии с реальным звучанием разговора.
  Корейское совещание с большим количеством английских названий продуктов
  требует других настроек, чем итальянский диалог двух говорящих.
- **Сочетания измеряются, а не принимаются на веру.** Публичные и синтетические
  тестовые данные, полнота терминов и частота ошибок находятся в этом
  репозитории. Поэтому смену модели или глоссария можно оценить повторяемым
  сравнением, а не догадкой.
- **Каждый запуск сохраняет свои свидетельства.** Закреплённые ревизии моделей,
  запись передачи глоссария, сырые транскрипции, временная шкала говорящих и
  типизированные ошибки опечатываются в данных запуска. Результат можно позже
  проверить и воспроизвести.

Заметки на уровне исходного кода, на которых основаны эти решения, находятся в
